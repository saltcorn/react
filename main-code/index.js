  ...
  for (const rootElement of rootElements) {
    ...
    remotesCfg.remotes.push({
      ...
      entry: isWeb
        ...
        timestamp
        ? `http://localhost/sc_plugins/public/react@0.1.9/${tenant}/${viewName}_${timestamp}/${viewName}_remote.js`
        : `http://localhost/sc_plugins/public/react@0.1.9/${tenant}/${viewName}_remote.js`,
    });
  }
